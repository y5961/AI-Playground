...
@app.post("/api/sources/search-web", response_model=WebSearchResponse)
def search_web_sources(req: WebSearchRequest) -> WebSearchResponse:
    """חיפוש בנושא והוספת מקורות מרשת."""
    return services.search_web(req)
